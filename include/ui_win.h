...
/*   Updated: 2020/01/21 18:25:32 by gmonacho    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void					ui_call_simple_function(t_win *win,
			t_simple_button *simple_button);
...
void					ui_update_frames_rect(t_win *win,
							SDL_bool force_update);
void					ui_update_buttons_rect(t_win *win,
							SDL_bool force_update);
